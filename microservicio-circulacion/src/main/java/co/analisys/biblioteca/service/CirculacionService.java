...
public class CirculacionService {
    ...
    @Autowired
    @org.springframework.beans.factory.annotation.Qualifier("restTemplateWithAuth")
    ...
    public void devolverLibro(PrestamoId prestamoId) {
        ...
        restTemplate.put("http://localhost:8082/libros/" + prestamo.getLibroId().getLibroid_value() + "/disponibilidad",
                true);
